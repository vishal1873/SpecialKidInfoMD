 ...
 * http://developer.android.com/training/com.livehospital.specialkidinfomd.sync-adapters/creating-authenticator.html
 * Which is a pretty handy reference when creating your own syncadapters.  Just sayin'.
 */
public class SpecialKidInfoAuthenticator extends AbstractAccountAuthenticator {

    public SpecialKidInfoAuthenticator(Context context) {
        super(context);
    }
